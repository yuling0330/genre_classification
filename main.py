...
def go(config: DictConfig):
    ...
    if "preprocess" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            parameters = {
                ...
                "artifact_description":"Raw data with preprocessing applied"
            }
            )
    ...
    if "segregate" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            "main",
            parameters = {
                "input_artifact":"preprocessed_data.csv:latest", # output of previous component
                "artifact_root":"data",
                "artifact_type":"segregate_dataset",
